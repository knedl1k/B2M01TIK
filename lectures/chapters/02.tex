...
\begin{itemize}
	...
	\item pro všechny $\alpha, \beta \in T$ a všechny $\ol{u}, \ol{u} \in L$:
	\begin{itemize}[$\cdot$]
...
\ii{Báze} lineární podprostoru $P$ je jeho lineárně nezávislá podmnožinu $B = \bc{\ol{b_1}, \dots, \ol{b_k}}$, která generuje celý prostor $P$. Báze budeme chápat jako uspořádaná báze.
...
\begin{itemize}
	...
	\end{equation}
	kde $\mathbb{D} = \left((-1)^{i+j} \det(\A_{ij})\right)$ a kde $\A_{ij}$ vznikla vyškrtnutím $i$-tého řádku a $j$-tého sloupce, je matice algebraických doplňků k $\A$.
